...
from datasets.transcenter_dataset.mot17 import MOT17
...
def main(args):
    ...
    dataset_train = MOT17(args, 'train')
    dataset_val = MOT17(args, 'val')
    ...
    # base_ds = convert_to_coco_api(base_val)
    ...
    if args.resume:
        ...
        if not args.eval and 'optimizer' in checkpoint and 'lr_scheduler' in checkpoint and 'epoch' in checkpoint \
                and "coco_pretrained.pth" not in args.resume and "CH_pretrained.pth" not in args.resume:
            import copy
