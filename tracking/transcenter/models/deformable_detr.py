...
class DeformableDETR(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_feature_levels,
                 aux_loss=True, input_shape=(640, 1088)):
    ...
    def forward(self, samples: NestedTensor, pre_samples: NestedTensor, pre_hm: Tensor, features: Tensor = None, pos: Tensor = None,
                pre_features: Tensor = None, pre_pos: Tensor = None):
