...
import numpy as np
from datasets.transcenter_dataset.mot20_val_save_mem import MOT20_val
...
from util.image import get_affine_transform, affine_transform, transform_preds_with_trans
...
def main(tracktor, reid):
    ...
    output_dirs = [
        # curr_pth + '/test_models/mot20_fromCoCo_test_pub_correct_bug/',
        curr_pth + '/test_models/mot20_fromCH_test_pub_correct_bug/',
    ...
    for model_dir, output_dir in zip(models, output_dirs):
        ...
        for seq, seq_n in data_loader:
            ...
            for idx, frame_name in enumerate(frames_list):
                ...
                tracker.step_reidV3_pre_tracking_mot20(batch)
