...
def main(tracktor, reid):
    ...
    # tracker
    tracker = Tracker(model, reid_network, liteFlowNet, tracktor['tracker'], postprocessor=postprocessors['bbox'],
                      main_args=main_args)
    ...
    output_dirs = [
        ...
        curr_pth + '/test_models/mot17_fromCH_test_pub/',
        ...
        for seq, seq_n in data_loader:
            ...
            for idx, frame_name in enumerate(frames_list):
                ...
                if trans_input is None:
                    ...
                    # trans_input =transform for resizing gt to input size
                ...
                # print(frame_name)
                # print("frame_dist:", batch['frame_dist'])
...
with open(curr_pth + '/cfgs/detracker_reidV3_pub.yaml', 'r') as f:
